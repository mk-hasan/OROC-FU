...
public class orocGetSameMSObject {
...
public ArrayList<String> result1(NodeList nodes, ArrayList<String> material_list, ArrayList<String> shape_list) {
...
public ArrayList<String> result2(NodeList nodes, ArrayList<String> material_list, ArrayList<String> shape_list) {
